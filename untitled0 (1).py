...
Original file is located at
    https://colab.research.google.com/drive/1jSu4jd8OTGO3dXYdyUnUij7OZ_3I2ARZ
"""
            ...
            if choice == "1":
                while True:
                  ...
                  if cardEdit.isnumeric() and int(cardEdit) == len(self.deck) + 1:
                      ...
                      card = self.deck[cardEditIndex]
                      self.hash_table.delete(card.question)
...
directory = "/content/gdrive/My Drive/Decks/"
